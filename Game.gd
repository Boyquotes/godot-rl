...
const snd_menu_amb = preload("res://sound/menu-ambience.ogg")
const snd_walk1 = preload("res://sound/footstep1.ogg")
const snd_walk2 = preload("res://sound/footstep2.ogg")
const snd_walk3 = preload("res://sound/footstep3.ogg")
const snd_walk_blood = preload("res://sound/footstep-blood1.ogg")
const snd_door_open = preload("res://sound/door1.ogg")
const snd_ladder = preload("res://sound/ladder2.ogg")
const snd_interlude = preload("res://sound/interlude.ogg")
const snd_enemy_hurt = preload("res://sound/enemy-hurt.ogg")
const snd_enemy_death = preload("res://sound/enemy-death.ogg")
const snd_music1 = preload("res://sound/music1.ogg")
const snd_music_death = preload("res://sound/music-death.ogg")
const snd_music_intro = preload("res://sound/music-intro.ogg")
const snd_music_title = preload("res://sound/music-title.ogg")
const snd_music_groundfloor = preload("res://sound/music-groundfloor.ogg")
const snd_music_shop = preload("res://sound/music-shop.ogg")
const snd_sewer_amb = preload("res://sound/ambience-sewer.ogg")
const snd_music_truewin = preload("res://sound/music-truewin.ogg")
const snd_ui_select = preload("res://sound/ui-select.ogg")
const snd_ui_back = preload("res://sound/ui-back.ogg")
const snd_ui_set = preload("res://sound/ui-set.ogg")
const snd_item_coin = preload("res://sound/item-coin.ogg")
const snd_item_potion = preload("res://sound/item-potion.ogg")
const snd_item_heart = preload("res://sound/item-heart.ogg")
const snd_purchase = preload("res://sound/purchase.ogg")
const snd_gethit = preload("res://sound/gethit.ogg")
